...
export default class validEspec extends Component {
  ...
  componentDidMount() {
    ...
    fetch(`http://localhost:3000/orcamentos/${this.props.match.params.id}`, {
      method: "GET",
      headers: new Headers({
        "Content-Type": "application/json",
        token: localStorage.getItem("auth-token")
  ...
  quandoClica() {
    if (
      this.state.products[this.state.index].descricao !== 0 &&
      this.state.products[this.state.index].justificativa !== 0
    ) {
      const requestInfo = {
        method: "PUT",
        body: JSON.stringify({
          descricao: this.state.products[this.state.index].descricao,
          ...
          <div id="Inputs">
            ...
            <FormGroup>
              ...
              <div id="InputButtonSiorg">
                <Input
                  ...
                  name="siorg"
                  value={this.state.products[this.state.index].siorg}
                  type="text"
                  id="inputSiorg"
                  disabled="true"
                />
              ...
              >
                ...
                <ModalFooter>
                  <Button color="primary" onClick={this.mandaSiorg}>
                    Confirmar
                  </Button>{" "}
            ...
            <FormGroup>
              ...
              <Input
                type="textarea"
                disabled={
                  this.state.products[this.state.index].siorg ? true : false
                }
            ...
            <FormGroup>
              ...
              <NumericInput
                min={1}
                max={1000}
                value={this.state.products[this.state.index].quantidade}
                strict={true}
            ...
            <FormGroup>
              ...
              <Input
                type="select"
                name="status"
                value={this.state.products[this.state.index].status}
                onChange={this.onChange}
                // disabled={
                //   this.state.products[this.state.index].siorg ? true : false
                // }
                disabled={this.state.listaOrcamentos.length < 3 ? true : false}
              >
            ...
            <FormGroup>
              ...
              <Input
                type="textarea"
                name="feedback"
                value={this.state.products[this.state.index].feedback}
                onChange={this.onChange}
                placeholder="Insira um comentário para o solicitante sobre o motivo da aprovação ou cancelamento da solicitação."
              />
              <FormFeedback>Preencha este campo!</FormFeedback>
            </FormGroup>
            ...
            <Orcamento
              isValidar={true}
              dado={this.props.match.params.id}
              urlGet={
            ...
            <div class="right">
              <Button id="confirm" color="primary" onClick={this.quandoClica}>
                Confirmar
              </Button>
              <Link to="/solicitacao/validar">
                <Button id="cancel" color="danger">
                  Cancelar
                </Button>
              </Link>
            </div>
