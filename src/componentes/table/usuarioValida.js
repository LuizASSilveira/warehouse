    ...
    return (
      <div id="table">
        ...
        >
          ...
          <TableHeaderColumn width='12%' dataField='usuario' dataAlign='center'>                        Usuario         </TableHeaderColumn>
          <TableHeaderColumn width='30%' dataField='departamento'>                                      departamento    </TableHeaderColumn>
          <TableHeaderColumn width='19%' dataField='email'>                                             email           </TableHeaderColumn>
